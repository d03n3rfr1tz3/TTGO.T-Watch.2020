...
static void enter_printer3d_app_event_cb( lv_obj_t * obj, lv_event_t event ) {
    switch( event ) {
        case( LV_EVENT_CLICKED ):       mainbar_jump_to_tilenumber( printer3d_app_main_tile_num, LV_ANIM_OFF, true );
                                        app_hide_indicator( printer3d_app );
                                        break;
    }    
}
...
static void enter_printer3d_widget_event_cb( lv_obj_t * obj, lv_event_t event ) {
    switch( event ) {
        case( LV_EVENT_CLICKED ):       widget_hide_indicator( printer3d_widget );
                                        mainbar_jump_to_tilenumber( printer3d_app_main_tile_num, LV_ANIM_OFF, true );
                                        break;
    }    
}
